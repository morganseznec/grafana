          ...
          <div className={styles.rightSide}>
            <div className={styles.timeRangeFilter}>
              <FilterInput
                ...
                placeholder={t({ id: 'timepicker-content.placeholder', message: 'Search quick ranges' })}
              />
            </div>
            <CustomScrollbar>
  ...
  return (
    <fieldset>
      <div className={styles.header}>
        ...
        >
          <TimePickerTitle>
            <Trans id="timepicker-content.title">Absolute time range</Trans>
          </TimePickerTitle>
      ...
      {!collapsed && (
        <div className={styles.body} id="expanded-timerange">
          ...
          {showHistory && (
            <TimeRangeList
              title={t({ id: 'timepicker-content.recently-used-abs-ranges', message: 'Recently used absolute ranges' })}
...
const EmptyRecentList = memo(() => {
  ...
  return (
    <div className={styles.container}>
      <div>
        <span>
          <Trans id="timepicker-content.not-used-before">
      ...
      <div>
        <a
          ...
          target="_new"
        >
          <Trans id="timepicker-content.read-the-docs">Read the documentation</Trans>
        </a>{' '}
        <span>
          <Trans id="timepicker-content.find-more">to find out more about how to enter custom time ranges.</Trans>
        </span>
      </div>
    </div>
  );
